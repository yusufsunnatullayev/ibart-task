    ...
    <section className="relative pt-16 pb-16 bg-gradient-to-br from-background via-background to-primary/5 overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="mb-16 animate-fade-up">
          <div className="relative bg-gradient-to-br from-card via-card to-primary/5 rounded-3xl p-10 shadow-strong border-2 border-primary/20 hover:shadow-strong hover:scale-[1.02] transition-all duration-500 overflow-hidden">
            {/* Decorative elements */}
            ...
            <div className="text-center relative z-10">
              <div className="w-28 h-28 bg-gradient-primary rounded-3xl flex items-center justify-center mx-auto mb-8 shadow-medium">
              ...
              <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
                Master all four IELTS skills with our comprehensive course
                package. Everything you need to achieve your target score with
              ...
              <Button
                size="lg"
                className="bg-gradient-primary hover:opacity-90 text-primary-foreground font-semibold px-8 py-6 text-lg rounded-full shadow-medium hover:shadow-strong transition-all duration-300"
                asChild
              >
                <Link href="/courses">
          ...
          {[
            {
              ...
              description:
                "Master listening skills with interactive exercises and real exam simulations",
              icon: Headphones,
            ...
            return (
              ...
              >
                <div
                  className={`relative bg-gradient-to-br ${course.bgGradient} to-card rounded-3xl p-8 shadow-soft border border-border/50 hover:shadow-strong hover:-translate-y-2 transition-all duration-500 overflow-hidden h-full`}
                >
                  ...
                  <div className="relative z-10">
                    <div
                      className={`w-20 h-20 bg-gradient-to-br ${course.gradient} rounded-3xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 shadow-medium`}
                    >
